...
if (!defined('__TIMEZONE_STRING')) {
    Debug::p_warning("__TIMEZONE_STRING not defined, using UTC");
    ...
    static protected function _get_fields_list() {
        ...
        if (static::$__fields[ $class ] === null) {
            ...
            foreach (static::GROUP_BY as $k => $v) {
                Debug::p_warning("GROUP_BY is not fully tested yet");
...
class DBObject extends DBObjectReadOnly {
    ...
    public static function create($values) {
        ...
        if ($id === null) {
            ...
            if ($id === false) {
                Debug::p_warning("Error inserting into table " . static::DB_TABLENAME . ": " . $db->get_error());
                return false;
            }
